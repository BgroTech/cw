...
export default function Footer() {
    return (
        <footer className="mt-auto">
            ...
            <div className="py-20 footer-bg text-white mt-20">
                <Container className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2 lg:col-span-1">
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="https://github.com/CodingWallah" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover-bg-primary hover-text-white transition-colors text-white/50">
                            ...
                            <a href="https://www.youtube.com/@CodingWallahSir" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover-bg-primary hover-text-white transition-colors text-white/50">
